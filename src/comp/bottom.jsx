        ...
        <div className="sociallinks">
            <div className="social">
                ...
                <div className="grid grid-cols-[8%_92%]">
                    <img className="h-4 self-start w-6" src={Usflag}/>
                    <p className="self-start text-sm">English, USA</p>
                </div>
                <div className="socialicons">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" class="socialIcon-32i0_n"><path fill="currentColor" d="M20.875 2H3.09375C2.46875 2 2 2.5 2 3.09375V20.875C2 21.5 2.5 21.9687 3.09375 21.9687H12.6875V14.2188H10.0625V11.1875H12.6562V8.96874C12.6562 6.375 14.2187 4.96875 16.5312 4.96875C17.625 4.96875 18.5937 5.0625 18.875 5.09375V7.78125H17.2812C16.0312 7.78125 15.7812 8.375 15.7812 9.25V11.1875H18.7812L18.4062 14.25H15.8125V22H20.9062C21.5312 22 22 21.5 22 20.9062V3.125C22 2.46875 21.5 2 20.875 2Z"></path></svg>
            ...
            <div className="links">
                <div className="linksec1">
                    <div className="mb-[2.5%] text-[#5865f2]">Product</div>
                    <div className="linkselem">Download</div>
                    <div className="linkselem">Nitro</div>
                    <div className="linkselem">Status</div>
                </div>
                <div className="linksec2">
                    <div className="mb-[2.5%] text-[#5865f2]">Company</div>
                    <div className="linkselem">About</div>
                    <div className="linkselem">Jobs</div>
                    <div className="linkselem">Branding</div>
                    <div className="linkselem">Newsroom</div>
                </div>
                <div className="linksec3">
                    <div className="mb-[2.5%] text-[#5865f2]">Resources</div>
                    <div className="linkselem">College</div>
                    <div className="linkselem">Support</div>
                    <div className="linkselem">Safety</div>
                    <div className="linkselem">Blog</div>
                    <div className="linkselem">Feedback</div>
                    <div className="linkselem">Developers</div>
                    <div className="linkselem">StreamKit</div>
                </div>
                <div className="linksec4">
                    <div className="mb-[2.5%] text-[#5865f2]">Policies</div>
                    <div className="linkselem">Terms</div>
                    <div className="linkselem">Privacy</div>
                    <div className="linkselem">Cookie Settings</div>
                    <div className="linkselem">Guidelines</div>
                    <div className="linkselem">Acknowledgements</div>
                    <div className="linkselem">Licenses</div>
                    <div className="linkselem">Moderation</div>
                </div>
            </div>
        </div>
        <div className="grid grid-cols-2 pt-[2.5%]">
            <img src={discordLogo}/>
            <Link to="/Register" className="grid grid-cols-1 justify-items-end rounded-full lg:ml-[85%] md:ml-[80%] lg:mb-[12%] md:mb-[20%] bg-[#5865f2] hover:cursor-pointer">
                <p className="self-center justify-self-center text-sm">Sign up</p>
            </Link>
        </div>
    </div>
  );
